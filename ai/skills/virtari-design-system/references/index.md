...
- `virtari-color-engine/SKILL.md` — Framework-agnostic OKLCH scale generation, brand-aware neutral recommendations, accent harmony suggestions, WCAG contrast selection and portable Virtari theme export.
